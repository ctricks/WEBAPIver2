...
namespace WEBAPI.Migrations
{
    ...
    [Migration("20231021011930_AddPhoneNumberInUserAmdmin")]
    partial class AddPhoneNumberInUserAmdmin
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WEBAPI.Entities.UserWallet", b =>
                {
                    ...
                    b.Property<string>("UserAdminUserName")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WEBAPI.Entities.UserWallet", b =>
                {
                    b.HasOne("WEBAPI.Entities.UserAdmin", null)
                        .WithMany("UWallet")
                        .HasForeignKey("UserAdminUserName");
